...
int __userpurge CDirectorScriptedEventManager::StartPanicEvent@<eax>(CDirectorScriptedEventManager *a1@<ecx>, int a2@<ebx>, signed int a3, int a4)
{
    ...
    float *v5; // edi
    int result; // eax
    CDirector *v7; // edi, seems name is 'TheDirector'
    double v8; // st7
    float v9; // ST28_4
    float v10; // xmm0_4
    char *v11; // edi
...
bool CDirectorScriptedEventManager::ShouldPanicForever(CDirectorScriptedEventManager a1)
{
	
}

void CDirectorScriptedEventManager::OnPanicEventFinished(CDirectorScriptedEventManager a1)
{
...
void CDirector::UpdateTempo()
{
	
}

void CDirector::UpdateTankSpawns()
{
...
int CDirector::GetMapArcValue(CDirector Name)
{
	
}

int CDirector::GetMegaMobSize(CDirector Name)
{
	
}

int CDirector::GetScriptValue(CDirector a1, int a2, int a3)
{
	
}

float __fastcall CDirector::GetPanicWavePauseMax(CDirector a1)
{
	
}

float __fastcall CDirector::GetPanicWavePauseMin(CDirector a1)
{
	
}

void CDirector::OnFinalePause(CDirector a1)
{
	
}

void CDirector::OnMobRushStart(CDirector a1)
{
	
}

bool CDirector::ShouldPausePanicWhenRelaxing(CDirector a1)
{
