...
// 1 byte
class CDirectorTacticalServices 
{
private:
...
class CDirector : public C_BaseEntity
{
public:
...
private:
	...
	int m_iTankCount; // 256, Possible from l4d1
